          			...
          			<a class="nav-link dropdown-toggle fw-semibold" href="#" data-bs-toggle="dropdown" style="color: #153462;" role="button" aria-expanded="false"><i class="fa-solid fa-user"></i> <?= $_SESSION['nama_lengkap'] ?>
			          	...
			          	<ul class="dropdown-menu p-5">
			          		...
			          		<li class="user-header">
			          			<img src="img/student.png" class="img-circle">
			          		</li>
			          		<li class="user-body">
			          			<div class="row">
	...
	<div class="container">
		...
		<section id="manualbook" class="mb-5 d-flex">
			<div class="text-center mt-5">
				...
				<h5 class="mt-3 text-center fw-bold fs-3">Role Student</h5>
					<?php
						$data = mysqli_query($koneksi,"select * from tb_buku where role = 'Student' order by id_buku asc");
						while ($b=mysqli_fetch_array($data)) {
					?>
				<div class="modul d-flex">
