...
<body>
	<nav class="navbar navbar-expand fixed-top bg-white shadow-sm">
  		<div class="container">
    		<h4 class=" navbar-brand mt-2 fw-bold" style="color: #153462;">Hyperloop Edu Pro</h4>
    	<div class="">
      		<ul class="navbar-nav">
        		<li class="nav-item">
		        ...
		        <!-- <li class="nav-item">
		          	<a class="nav-link fw-semibold" href="login.php" style="color: #153462;">Logout</a>
		        </li> -->
	...
	<div class="container">
		...
		<section id="manualbook" class="mb-5 d-flex">
			<div class="text-center mt-5">
				...
				<h5 class="mt-3 text-center fw-bold fs-3">Role Admin</h5>
					<?php
						$data = mysqli_query($koneksi,"select * from tb_buku where role = 'Admin' order by id_buku asc");
